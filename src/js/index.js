      ...
      menuSectionEl.innerHTML += `
            <div class="menu-item">
                ...
                <div class="menu-item-info">
                    ...
                    <div class="item-ingredients">${ingredients.join(
        ", "
      )}</div>
    ...
    getCheckoutHtml += `
            <div class="cart-list" id="cart-list">  
                <div class="cart-item-info">
                    ...
                    <p id="cart-item-qty" class="cart-item-qty">x ${item.quantity
      }</p>
                    <button id="remove-item-btn" class="remove-item-btn" data-remove="${item.id
      }">remove</button>
